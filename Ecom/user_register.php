...
if(isset($_POST['User_submit'])){
    ...
    // echo "<PRE>";
    // print_r($_POST);
     $insert_query="select * from `user` where email_id='$user_email' && user_phone='$user_Phone' ";
     ...
     if($number>0){
        ...
        if($user_password != $user_cpassword){
            ...
            $insert_query="insert into `user` (user_name,email_id,user_phone,user_address,user_password,
            user_cpassword) value ('$user_name','$user_email','$user_Phone','$user_address','$user_password',
            '$user_cpassword')";
...
<div class="container">
        ...
        <!-- user phone -->
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="User_Phone" class="form-label"><b>Phone number:</b></label>
                <input type="text" name="user_phone" id="user_phone" class="form-control"
                 placeholder="Enter your Phone  Number" autocomplate="off" require="required">  
            </div>
        <!-- user address -->
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="user_address" id="user_address" class="form-control"
                 placeholder="Enter your address" autocomplate="off" require="required">  
            </div>
        <!-- user password -->
            <div class="form-outline mb-4 w-50 m-auto">
